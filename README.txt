...
Student name:
Student number:
Hours spent on requirements (approx.30):
...
- What are you studying here at Aalto? (Department, major, minor...?) Data Science major Math minor

- Which year of your studies is this? 3

- Is this a mandatory course for you? no

- Have you had something to do with graphics before? Other studies, personal interests, work? no

- Do you remember basic linear algebra? Matrix and vector multiplication, cross product, that sort of thing? a bit

- How is your overall programming experience? What language are you most comfortable with? I like C
...
R2 Generating a simple cone mesh and normals (3p):  done (i did generate normals, however I can't get the shading algebra right)
...
-Window rescaling distorts meshes to fit the window (can be fixed with proj matrix)
-Holding down mouse 1 and moving mouse inside window rotates view, but not in an intuitive way
...
I wrote this from scratch in c in a linux environment, it works on the windows pcs I tested it on, however I cannot get the package installs
fully automated, try the makefile
type: 

make run

in your console it should automatically install dependencies using vpkg but this is untested
if this does not work, please look at the makefile and manually compile with dependencies, I am struggling bro please
